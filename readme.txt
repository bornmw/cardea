...
Lightweight, zero-dependency Proof-of-Work anti-spam protection for WordPress comments. Uses client-side cryptographic mining to filter out automated spam without third-party services.
